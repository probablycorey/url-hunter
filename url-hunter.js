...
var _templateObject = _taggedTemplateLiteral(['#  You killed ', ' animal', ' in ', ' seconds! (Press ESC to play again)'], ['#  You killed ', ' animal', ' in ', ' seconds! (Press ESC to play again)']);
...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function gameOver() {
      ...
      location.replace(_templateObject, this.points, this.points == 1 ? '' : '\'s', this.elapsedTime());
    }
  }, {
    key: 'elapsedTime',
